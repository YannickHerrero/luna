...
CREATE UNIQUE INDEX `apns_token_unique` ON `apns_registrations` (`token`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `attachments_conversation_index` ON `attachments` (`conversation_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `conversations_pi_session_path_unique` ON `conversations` (`pi_session_path`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `dispatches_message_unique` ON `dispatches` (`message_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `messages_conversation_ordinal_unique` ON `messages` (`conversation_id`,`ordinal`);--> statement-breakpoint
CREATE UNIQUE INDEX `messages_device_client_id_unique` ON `messages` (`sent_by_device_id`,`client_message_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `messages_pi_entry_id_unique` ON `messages` (`pi_entry_id`);--> statement-breakpoint
CREATE INDEX `messages_conversation_created_index` ON `messages` (`conversation_id`,`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `notification_delivery_unique` ON `notification_deliveries` (`message_id`,`target_device_id`,`channel`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `repositories_root_unique` ON `repositories` (`canonical_root`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `session_runs_conversation_index` ON `session_runs` (`conversation_id`,`started_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `sync_events_conversation_index` ON `sync_events` (`conversation_id`,`id`);--> statement-breakpoint
